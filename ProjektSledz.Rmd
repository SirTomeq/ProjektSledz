...
### Podsumowanie
Analiza problemu coraz krótszego œledzia by³a z³o¿ona. Po wczytaniu danych, uzupe³niono brakuj¹ce wartoœci. Zdecydowano siê na przewidywanie wartoœci przez algorytm random forest. Dobór parametrów by³ empiryczno-losowy. Przy zmianie liczby powtórzeñ oceny krzy¿owej, czy wartoœci mtry lub seeda ranking wa¿noœci atrybutów potrafi³ siê zmieniæ diametralnie, przy zbli¿onej wartoœci miary RMSE. </br></br>
Próbuj¹c odpowiedzieæ na pytanie dlaczego œledŸ oceaniczny jest coraz krótszy porównano zmiany atrybutów w czasie oraz ranking zgodny z algorytmem predykcji.
</br></br>
Spadaj¹ce pocz¹tkowo natê¿enie po³owów œledzi, temeratura przy powierzchni wody, a tak¿e oscylacja pó³nocnoatlantycka sprzyja³y wzrostowi œledzia oceanicznego, a tak¿e dostêpnoœci glonów Calanus helgolandicus oraz wid³onogów gatunku pierwszego. Przy wzroœcie po³owów oraz temperatury przy powierzchni wody sytuacja zaczê³a siê zmieniaæ. Zarówno liczba zagêszczenia wspomnianych planktonów, jak i d³ugoœæ œledzi zaczê³a spadaæ. 
